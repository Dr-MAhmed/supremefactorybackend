            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="text-lg font-medium text-slate-900">Journal Entries</h3>
                  <button
                    type="button"
                    ...
                    <div key={field.id} className="grid grid-cols-12 gap-4 items-end">
                      <div className="col-span-4">
                        ...
                        {errors.entries?.[index]?.accountId && (
                          <p className="mt-1 text-sm text-red-600">{errors.entries[index].accountId.message}</p>
                        )}
                      </div>
                      <div className="col-span-2">
                        ...
                        {errors.entries?.[index]?.debit && (
                          <p className="mt-1 text-sm text-red-600">{errors.entries[index].debit.message}</p>
                        )}
                      </div>
                      <div className="col-span-2">
                        ...
                        {errors.entries?.[index]?.credit && (
                          <p className="mt-1 text-sm text-red-600">{errors.entries[index].credit.message}</p>
                        )}
                      </div>
                ...
                {errors.entries && typeof errors.entries.message === 'string' && (
                  <p className="mt-2 text-sm text-red-600">{errors.entries.message}</p>
                )}
              </div>
